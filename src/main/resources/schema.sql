...
CREATE TABLE IF NOT EXISTS movie_record (
                              ...
                              category VARCHAR(128) DEFAULT NULL COMMENT '电影类型，如喜剧、爱情、科幻',
                              region VARCHAR(64) DEFAULT NULL COMMENT '国家/地区，如中国、日本、美国',
                              ...
                              rating DECIMAL(3,1) DEFAULT NULL COMMENT '个人评分，0-10分',
                              ...
                              KEY idx_user_watch_status (user_id, watch_status),
                              KEY idx_user_updated_at (user_id, updated_at),
